...
android {
    namespace = "com.mkshmnv.djinni"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mkshmnv.djinni"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "0.1"
...
dependencies {
    ...
    // LinkedIn SDK
//    val linkedinVersion = "1.1.4"
//    implementation("com.linkedin.android.mobilesdk:linkedin-sdk:$linkedinVersion")
